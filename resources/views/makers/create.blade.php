    ...
    <div class="min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-10 py-10">
        ...
        <div class="mb-10">
            ...
            <p class="mt-3 text-gray-500 text-lg max-w-2xl">
                Add a new vehicle maker to your system.
            </p>
        </div>
        ...
        <div class="bg-white w-full rounded-2xl shadow-lg p-6 sm:p-10">
            ...
            <form method="POST" action="{{ route('makers.store') }}"
                ...
                <div class="w-full">
                    ...
                    <input type="text"
                           ...
                           class="w-full p-4 border border-gray-300 rounded-xl
                                  focus:ring-2 focus:ring-main-400 focus:border-main-400
                ...
                <div class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-4">
                    ...
                    <button type="submit"
                            class="w-full sm:w-auto px-6 py-3 bg-main-600 text-white rounded-xl hover:bg-main-700 transition shadow">
                        Save Maker
                    </button>
